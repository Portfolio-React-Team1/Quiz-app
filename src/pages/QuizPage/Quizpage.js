...
const Quizpage = () => {
  ...
  const currentQuestion = QuestionBanks.slice(indexOfFirstQuestion, indexOfLastQuestion);
          ...
          >
            <Card.Body style={{ width: '100%' }}>
              ...
              style={{ 
                ...
                <hr></hr>
                <br/>
                  <QuizPagination questionperpage={QuestionPerPage} totalquestion={5} paginate={paginate}/>
